...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<capybara>.freeze, ["< 4", ">= 2.12"])
      s.add_runtime_dependency(%q<cucumber>.freeze, ["< 4", ">= 3.0.2"])
      s.add_runtime_dependency(%q<mime-types>.freeze, ["< 4", ">= 2.0"])
      ...
      s.add_development_dependency(%q<rails>.freeze, ["< 7", ">= 4.2"])
      ...
      s.add_dependency(%q<capybara>.freeze, ["< 4", ">= 2.12"])
      s.add_dependency(%q<cucumber>.freeze, ["< 4", ">= 3.0.2"])
      s.add_dependency(%q<mime-types>.freeze, ["< 4", ">= 2.0"])
      ...
      s.add_dependency(%q<rails>.freeze, ["< 7", ">= 4.2"])
